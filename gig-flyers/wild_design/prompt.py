...
_INTENSITY_BLOCKS: dict[str, dict[str, str]] = {
    "wild": {
        ...
        "avoid_extra": "Plain white/cream photo mats, PowerPoint-style blocks.",
    },
    "wild_medium": {
        "label": "BALANCED",
        "energy": (
        ...
        "avoid_extra": "Over-cluttered collage, illegible type, extreme face warping.",
    },
    "wild_subtle": {
        "label": "REFINED",
        "energy": (
        ...
        "avoid_extra": "Heavy distortion, neon chaos, illegible text, stock festival symmetry.",
    },
}
